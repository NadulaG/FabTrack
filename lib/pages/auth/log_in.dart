                    ...
                    child: Column(
                      ...
                      children: const [
                        Text("North Carolina",
                              ...
                              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Montserrat', color:Color.fromARGB(255,90,89,93), ),
                        ),
                        Text("School of Science",
                              maxLines: 1,
                              softWrap: false,
                              textAlign: TextAlign.left,
                              style: TextStyle(fontSize: 20, fontFamily: 'Montserrat',  fontWeight: FontWeight.bold, color:Color.fromARGB(255,90,89,93),),
                        ),
